# SearchSolution.py
# Designed to format the output of BFS, DFS, and IDS search, for a given problem.
...
class SearchSolution:
    ...
    def __str__(self):
        ...
        if len(self.path) > 0:
            ...
            string = string.format(self.problem_name, self.search_method, self.nodes_visited, len(self.path), str(self.path))
        else:
